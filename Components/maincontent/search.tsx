...
// This component will use Suspense to handle the client-side only behavior
const Search = () => {
  const searchParams = useSearchParams();
...
// A fallback component to display while loading
...
// Dynamic import with ssr: false to disable server-side rendering
